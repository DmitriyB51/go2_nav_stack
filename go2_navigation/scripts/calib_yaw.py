#!/usr/bin/env python3
"""Калибровка mount_yaw_deg: гоним собаку строго вперёд, направление реального
движения по карте и есть её "вперёд". Разница с курсом base_link из TF = ошибка.
...
Проехать 2-3 м по прямой, потом Ctrl+C в окне C.
"""
import math
import time
...
# через вектор, иначе ±180° ломает среднее
